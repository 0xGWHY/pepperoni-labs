...
contract TokenPaymaster is BasePaymaster, ERC20 {
    ...
    uint256 public constant COST_OF_POST = 15_000;
     ...
     * this method will be called just after the user's TX with mode==OpSucceeded|OpReverted (account pays in both
     * cases)
     * BUT: if the user changed its balance in a way that will cause  postOp to revert, then it gets called again, after
     * reverting
