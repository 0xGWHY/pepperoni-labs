...
contract Example is ActionBase {
        ...
        returns (bytes32 result)
    {
        ...
        result = bytes32(/** something */0);

        bytes memory logData = abi.encode(_queueId/** something */);
    ...
    function executeActionDirect(bytes memory _params) public payable override {
        ...
        // action 단독 실행 기록
        bytes memory logData = abi.encode(_params/** something */);
        logger.loglogActionDirectEventDirect("contractName", logData);
